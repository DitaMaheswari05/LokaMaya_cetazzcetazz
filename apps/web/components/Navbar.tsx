  ...
  return (
    <nav className="w-full h-[60px] bg-white border-b border-[#E2E2EF] flex items-center justify-between px-4 md:px-8 shadow-[0px_1px_3px_rgba(45,42,112,0.06)] z-50 flex-shrink-0">
      ...
      <div className="flex items-center gap-3">
        <div className="hidden md:flex bg-[#F0F0F6] rounded-lg px-3.5 py-1.5">
          <span className="text-[13px] font-medium text-[#4B4B6F]">DKI Jakarta</span>
        </div>
        <div className="w-[34px] h-[34px] bg-[#2D2A70] rounded-full flex items-center justify-center text-white text-[12px] font-bold">
          AA
        </div>
      </div>
    </nav>
